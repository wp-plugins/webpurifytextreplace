...
<div class="wrap"> 
	...
	<form name="form1" method="post" action="<?php echo(get_option('siteurl') . '/wp-admin/admin.php?page=webpurify/WebPurifyTextReplace-options.php'); ?>">

		<fieldset class="options">
			    <?php _e('Enter WebPurify API Key', 'WebPurifyTextReplace') ?>: <input type="text" name="webpurify_key" value="<?= $userkey ?>" />
                <br/><br />
